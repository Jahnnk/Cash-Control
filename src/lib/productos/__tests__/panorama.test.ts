...
describe("a qué familia pertenece cada producto", () => {
  it.each([
    ...
    ["PAN INTEGRAL MULTIGRANO TIPO MOLDE 750 G", "Panadería"],
    ...
    ["BOSQUE ENCANTADO", "Bebidas calientes"],
    ["CHOCOLATE CALIENTE", "Bebidas calientes"],
    ["MILKSHAKE VAINILLA", "Bebidas frías"],
    ["CHILCANO FRUTADO", "Cócteles y bar"],
    ["PIÑA COLADA", "Cócteles y bar"],
    ["MARACUYÁ SOUR", "Cócteles y bar"],
    ["COLD BREW", "Bebidas frías"],
