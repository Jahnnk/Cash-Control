...
const CENTRO: KpiTargets = { ventaDiaria: 1266, ticketRef: 24.25, npsMin: 9, mermasMaxPct: 0.04, tiempoMaxMin: 6, tiempoMesaMaxMin: 15, tiempoDeliveryMaxMin: 20 };

/** La semana real del cuadro de Notion (Centro, 21-27 jun). Personas
 *  derivadas de ticket = ventas/personas del cuadro. */
const WEEK: KpiDaily[] = [
  { date: "2026-06-21", ventas: 1798.2, personas: 69, nps: 9.8, mermasSoles: 35, tiempoMin: null, tiempoMesaMin: null, tiempoDeliveryMin: null },   // ticket 26.06
  { date: "2026-06-22", ventas: 1261.5, personas: 51, nps: 9.6, mermasSoles: 0, tiempoMin: null, tiempoMesaMin: null, tiempoDeliveryMin: null },    // 24.74
  { date: "2026-06-23", ventas: 1084.9, personas: 56, nps: 9.2, mermasSoles: 27, tiempoMin: null, tiempoMesaMin: null, tiempoDeliveryMin: null },   // 19.37
  { date: "2026-06-24", ventas: 939.0, personas: 37, nps: 9.78, mermasSoles: 0, tiempoMin: null, tiempoMesaMin: null, tiempoDeliveryMin: null },    // 25.38
  { date: "2026-06-25", ventas: 1188.6, personas: 53, nps: 9.8, mermasSoles: 20, tiempoMin: null, tiempoMesaMin: null, tiempoDeliveryMin: null },   // 22.43
  { date: "2026-06-26", ventas: 800.7, personas: 44, nps: 9.0, mermasSoles: 0, tiempoMin: null, tiempoMesaMin: null, tiempoDeliveryMin: null },     // 18.20
  { date: "2026-06-27", ventas: 1275.7, personas: 53, nps: 9.3, mermasSoles: 0, tiempoMin: null, tiempoMesaMin: null, tiempoDeliveryMin: null },    // 24.07
];
...
describe("semáforos diarios — reproducen el cuadro de Notion", () => {
  ...
  it("tiempos partidos: mostrador (<6) y mesa (<15) semaforizan por separado", () => {
    ...
    const d = computeDayView({ ...WEEK[0], tiempoMin: 5, tiempoMesaMin: 19, tiempoDeliveryMin: null }, CENTRO);
    ...
    const a = computeDayView({ ...WEEK[0], tiempoMin: 7, tiempoMesaMin: 17, tiempoDeliveryMin: null }, CENTRO);
  ...
  it("promedios semanales de los dos tiempos, cada uno con su semáforo", () => {
    const week = WEEK.map((d, i) => ({ ...d, tiempoMin: 5 + (i % 2), tiempoMesaMin: 12, tiempoDeliveryMin: null }));
