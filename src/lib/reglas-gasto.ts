...
export const REGLAS_GASTO: ReglaGasto[] = [
  ...
  ...r("INSUMOS", "INSUMO", "FRUTA", "VERDURA", "POLLO", "PECHUGA", "PECHGA", " PAVO ", "CARNE", "HAMBURGUESA", "HAMBURUESA", "HAMURGUESA", "JAMON",
    ...
    "AGUA MINERAL", "BIDON", "BODONES", "AGUA SAN LUIS", "COMPRAS EN METRO", "COMPRAS METRO", "1 PISCO ", "PISCOOCUCAJE", "QUEBRANTA", "COPAS Y TRAGOS", "ARROZ", "FIDEO", "CANELA", "COCO", "PLATANO", "MANGO", "PINA ", "MARACUYA"),
  ...
  // El IR de SUNAT se paga en cuotas: "IR JULIO – 2DA CUOTA (SUNAT)" es impuesto, no préstamo.
  ...r("IMPUESTOS", " IR ", "CUOTA SUNAT", "CUOTA (SUNAT"),
