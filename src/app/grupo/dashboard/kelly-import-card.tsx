 ...
 * abrir el modal — dos botones explícitos, nada de adivinar de qué
 * sede es el archivo (los Excel son idénticos en formato y un import
 * en la sede equivocada sería un incidente de datos silencioso).
 * La sede elegida viaja explícita hasta las actions (sedeCentral).
 */
